...
int main()
{
    ...
    outputImagebw = fopen("f10_BWSch.bmp","wb");    //Imagen transformada
    outputImagein = fopen("f10_INSch.bmp","wb");    //Imagen transformada
    outputImagebl = fopen("f10_BLSch.bmp","wb");
